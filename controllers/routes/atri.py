...
class Atri:
	def __init__(self, state: Any):
		...
		self.trustedsection = state["trustedsection"]
		self.Div5 = state["Div5"]
		self.Div6 = state["Div6"]
		self.Flex7 = state["Flex7"]
		self.servicesection = state["servicesection"]
		...
		self.productsection = state["productsection"]
		...
		self.worksection = state["worksection"]
		self.Div37 = state["Div37"]
		self.standfordbox = state["standfordbox"]
		...
		self.bookacall = state["bookacall"]
		self.arrow = state["arrow"]
		self.subtext = state["subtext"]
		self.text2 = state["text2"]
		self.text1 = state["text1"]
		self.download = state["download"]
		self.bookacallbutton = state["bookacallbutton"]
		self.Image37 = state["Image37"]
		self.personimg = state["personimg"]
		self.Trusted_by = state["Trusted_by"]
		self.logoispum1 = state["logoispum1"]
		self.logoispum2 = state["logoispum2"]
		self.logoispum3 = state["logoispum3"]
		self.logoispum4 = state["logoispum4"]
		self.SERVICES = state["SERVICES"]
		self.servicesubtext = state["servicesubtext"]
		self.box1titlte = state["box1titlte"]
		self.box1subtext = state["box1subtext"]
		self.serviceimg1 = state["serviceimg1"]
		self.Design = state["Design"]
		self.Front = state["Front"]
		self.Web = state["Web"]
		self.box2subtext = state["box2subtext"]
		self.box2titlte = state["box2titlte"]
		self.Webflow = state["Webflow"]
		self.Figma = state["Figma"]
		self._Sketch = state["_Sketch"]
		self.serviceimg2 = state["serviceimg2"]
		self.box3subtext = state["box3subtext"]
		self.box3titlte = state["box3titlte"]
		self.device = state["device"]
		self.Efficient = state["Efficient"]
		self.clean = state["clean"]
		self.serviceimg3 = state["serviceimg3"]
		self.PROJECTS = state["PROJECTS"]
		self.Ibringresults = state["Ibringresults"]
		self.Myclientsareproof = state["Myclientsareproof"]
		self.View = state["View"]
		self.BRANDING = state["BRANDING"]
		self.SoulfulRebrand = state["SoulfulRebrand"]
		...
		self.PRODUCT_DESIGNER = state["PRODUCT_DESIGNER"]
		self.Thatme = state["Thatme"]
	...
	def start(self, new_state):
		...
		global default_state
		self._start = Flex(new_state, default_state["start"])
	...
	def text(self):
		...
		return self._text
	@text.setter
	def text(self, new_state):
		self._setter_access_tracker["text"] = {}
		global default_state
		self._text = Div(new_state, default_state["text"])
	...
	def image(self, new_state):
		...
		global default_state
		self._image = Div(new_state, default_state["image"])

	@property
	def trustedsection(self):
		self._getter_access_tracker["trustedsection"] = {}
		return self._trustedsection
	@trustedsection.setter
	def trustedsection(self, new_state):
		self._setter_access_tracker["trustedsection"] = {}
		global default_state
		self._trustedsection = Flex(new_state, default_state["trustedsection"])
	...
	@property
	def servicesection(self):
		self._getter_access_tracker["servicesection"] = {}
		return self._servicesection
	@servicesection.setter
	def servicesection(self, new_state):
		self._setter_access_tracker["servicesection"] = {}
		global default_state
		self._servicesection = Flex(new_state, default_state["servicesection"])
	...
	@property
	def bolgsection(self):
		self._getter_access_tracker["bolgsection"] = {}
		return self._bolgsection
	@bolgsection.setter
	def bolgsection(self, new_state):
		self._setter_access_tracker["bolgsection"] = {}
		global default_state
		self._bolgsection = Div(new_state, default_state["bolgsection"])
	...
	@property
	def box1(self):
		self._getter_access_tracker["box1"] = {}
		return self._box1
	@box1.setter
	def box1(self, new_state):
		self._setter_access_tracker["box1"] = {}
		global default_state
		self._box1 = Flex(new_state, default_state["box1"])
	...
	def date(self, new_state):
		...
		global default_state
		self._date = Flex(new_state, default_state["date"])

	@property
	def read(self):
		self._getter_access_tracker["read"] = {}
		return self._read
	@read.setter
	def read(self, new_state):
		self._setter_access_tracker["read"] = {}
		global default_state
		self._read = Flex(new_state, default_state["read"])
	...
	@property
	def productsection(self):
		self._getter_access_tracker["productsection"] = {}
		return self._productsection
	@productsection.setter
	def productsection(self, new_state):
		self._setter_access_tracker["productsection"] = {}
		global default_state
		self._productsection = Flex(new_state, default_state["productsection"])
	...
	def images(self, new_state):
		...
		global default_state
		self._images = Div(new_state, default_state["images"])
	...
	@property
	def worksection(self):
		self._getter_access_tracker["worksection"] = {}
		return self._worksection
	@worksection.setter
	def worksection(self, new_state):
		self._setter_access_tracker["worksection"] = {}
		global default_state
		self._worksection = Flex(new_state, default_state["worksection"])
	...
	@property
	def standfordbox(self):
		self._getter_access_tracker["standfordbox"] = {}
		return self._standfordbox
	@standfordbox.setter
	def standfordbox(self, new_state):
		self._setter_access_tracker["standfordbox"] = {}
		global default_state
		self._standfordbox = Flex(new_state, default_state["standfordbox"])
	...
	def testimonialsection(self, new_state):
		...
		global default_state
		self._testimonialsection = Flex(new_state, default_state["testimonialsection"])
	...
	def footer(self, new_state):
		...
		global default_state
		self._footer = Div(new_state, default_state["footer"])
	...
	@property
	def service(self):
		self._getter_access_tracker["service"] = {}
		return self._service
	@service.setter
	def service(self, new_state):
		self._setter_access_tracker["service"] = {}
		global default_state
		self._service = TextBox(new_state, default_state["service"])

	@property
	def project(self):
		self._getter_access_tracker["project"] = {}
		return self._project
	@project.setter
	def project(self, new_state):
		self._setter_access_tracker["project"] = {}
		global default_state
		self._project = TextBox(new_state, default_state["project"])
	...
	@property
	def bookacall(self):
		self._getter_access_tracker["bookacall"] = {}
		return self._bookacall
	@bookacall.setter
	def bookacall(self, new_state):
		self._setter_access_tracker["bookacall"] = {}
		global default_state
		self._bookacall = TextBox(new_state, default_state["bookacall"])

	@property
	def arrow(self):
		self._getter_access_tracker["arrow"] = {}
		return self._arrow
	@arrow.setter
	def arrow(self, new_state):
		self._setter_access_tracker["arrow"] = {}
		global default_state
		self._arrow = Image(new_state, default_state["arrow"])

	@property
	def subtext(self):
		self._getter_access_tracker["subtext"] = {}
		return self._subtext
	@subtext.setter
	def subtext(self, new_state):
		self._setter_access_tracker["subtext"] = {}
		global default_state
		self._subtext = TextBox(new_state, default_state["subtext"])

	@property
	def text2(self):
		self._getter_access_tracker["text2"] = {}
		return self._text2
	@text2.setter
	def text2(self, new_state):
		self._setter_access_tracker["text2"] = {}
		global default_state
		self._text2 = TextBox(new_state, default_state["text2"])

	@property
	def text1(self):
		self._getter_access_tracker["text1"] = {}
		return self._text1
	@text1.setter
	def text1(self, new_state):
		self._setter_access_tracker["text1"] = {}
		global default_state
		self._text1 = TextBox(new_state, default_state["text1"])
	...
	@download.setter
	def download(self, new_state):
		self._setter_access_tracker["download"] = {}
		global default_state
		self._download = TextBox(new_state, default_state["download"])

	@property
	def bookacallbutton(self):
		self._getter_access_tracker["bookacallbutton"] = {}
		return self._bookacallbutton
	@bookacallbutton.setter
	def bookacallbutton(self, new_state):
		self._setter_access_tracker["bookacallbutton"] = {}
		global default_state
		self._bookacallbutton = Button(new_state, default_state["bookacallbutton"])
	...
	@property
	def personimg(self):
		self._getter_access_tracker["personimg"] = {}
		return self._personimg
	@personimg.setter
	def personimg(self, new_state):
		self._setter_access_tracker["personimg"] = {}
		global default_state
		self._personimg = Image(new_state, default_state["personimg"])
	...
	@property
	def logoispum1(self):
		self._getter_access_tracker["logoispum1"] = {}
		return self._logoispum1
	@logoispum1.setter
	def logoispum1(self, new_state):
		self._setter_access_tracker["logoispum1"] = {}
		global default_state
		self._logoispum1 = Image(new_state, default_state["logoispum1"])

	@property
	def logoispum2(self):
		self._getter_access_tracker["logoispum2"] = {}
		return self._logoispum2
	@logoispum2.setter
	def logoispum2(self, new_state):
		self._setter_access_tracker["logoispum2"] = {}
		global default_state
		self._logoispum2 = Image(new_state, default_state["logoispum2"])

	@property
	def logoispum3(self):
		self._getter_access_tracker["logoispum3"] = {}
		return self._logoispum3
	@logoispum3.setter
	def logoispum3(self, new_state):
		self._setter_access_tracker["logoispum3"] = {}
		global default_state
		self._logoispum3 = Image(new_state, default_state["logoispum3"])

	@property
	def logoispum4(self):
		self._getter_access_tracker["logoispum4"] = {}
		return self._logoispum4
	@logoispum4.setter
	def logoispum4(self, new_state):
		self._setter_access_tracker["logoispum4"] = {}
		global default_state
		self._logoispum4 = Image(new_state, default_state["logoispum4"])
	...
	@property
	def servicesubtext(self):
		self._getter_access_tracker["servicesubtext"] = {}
		return self._servicesubtext
	@servicesubtext.setter
	def servicesubtext(self, new_state):
		self._setter_access_tracker["servicesubtext"] = {}
		global default_state
		self._servicesubtext = TextBox(new_state, default_state["servicesubtext"])

	@property
	def box1titlte(self):
		self._getter_access_tracker["box1titlte"] = {}
		return self._box1titlte
	@box1titlte.setter
	def box1titlte(self, new_state):
		self._setter_access_tracker["box1titlte"] = {}
		global default_state
		self._box1titlte = TextBox(new_state, default_state["box1titlte"])

	@property
	def box1subtext(self):
		self._getter_access_tracker["box1subtext"] = {}
		return self._box1subtext
	@box1subtext.setter
	def box1subtext(self, new_state):
		self._setter_access_tracker["box1subtext"] = {}
		global default_state
		self._box1subtext = TextBox(new_state, default_state["box1subtext"])
	...
	def Design(self, new_state):
		...
		global default_state
		self._Design = TextBox(new_state, default_state["Design"])

	@property
	def Front(self):
		self._getter_access_tracker["Front"] = {}
		return self._Front
	@Front.setter
	def Front(self, new_state):
		self._setter_access_tracker["Front"] = {}
		global default_state
		self._Front = TextBox(new_state, default_state["Front"])

	@property
	def Web(self):
		self._getter_access_tracker["Web"] = {}
		return self._Web
	@Web.setter
	def Web(self, new_state):
		self._setter_access_tracker["Web"] = {}
		global default_state
		self._Web = TextBox(new_state, default_state["Web"])

	@property
	def box2subtext(self):
		self._getter_access_tracker["box2subtext"] = {}
		return self._box2subtext
	@box2subtext.setter
	def box2subtext(self, new_state):
		self._setter_access_tracker["box2subtext"] = {}
		global default_state
		self._box2subtext = TextBox(new_state, default_state["box2subtext"])

	@property
	def box2titlte(self):
		self._getter_access_tracker["box2titlte"] = {}
		return self._box2titlte
	@box2titlte.setter
	def box2titlte(self, new_state):
		self._setter_access_tracker["box2titlte"] = {}
		global default_state
		self._box2titlte = TextBox(new_state, default_state["box2titlte"])

	@property
	def Webflow(self):
		self._getter_access_tracker["Webflow"] = {}
		return self._Webflow
	@Webflow.setter
	def Webflow(self, new_state):
		self._setter_access_tracker["Webflow"] = {}
		global default_state
		self._Webflow = TextBox(new_state, default_state["Webflow"])

	@property
	def Figma(self):
		self._getter_access_tracker["Figma"] = {}
		return self._Figma
	@Figma.setter
	def Figma(self, new_state):
		self._setter_access_tracker["Figma"] = {}
		global default_state
		self._Figma = TextBox(new_state, default_state["Figma"])

	@property
	def _Sketch(self):
		self._getter_access_tracker["_Sketch"] = {}
		return self.__Sketch
	@_Sketch.setter
	def _Sketch(self, new_state):
		self._setter_access_tracker["_Sketch"] = {}
		global default_state
		self.__Sketch = TextBox(new_state, default_state["_Sketch"])

	@property
	def serviceimg2(self):
		self._getter_access_tracker["serviceimg2"] = {}
		return self._serviceimg2
	@serviceimg2.setter
	def serviceimg2(self, new_state):
		self._setter_access_tracker["serviceimg2"] = {}
		global default_state
		self._serviceimg2 = Image(new_state, default_state["serviceimg2"])

	@property
	def box3subtext(self):
		self._getter_access_tracker["box3subtext"] = {}
		return self._box3subtext
	@box3subtext.setter
	def box3subtext(self, new_state):
		self._setter_access_tracker["box3subtext"] = {}
		global default_state
		self._box3subtext = TextBox(new_state, default_state["box3subtext"])

	@property
	def box3titlte(self):
		self._getter_access_tracker["box3titlte"] = {}
		return self._box3titlte
	@box3titlte.setter
	def box3titlte(self, new_state):
		self._setter_access_tracker["box3titlte"] = {}
		global default_state
		self._box3titlte = TextBox(new_state, default_state["box3titlte"])

	@property
	def device(self):
		self._getter_access_tracker["device"] = {}
		return self._device
	@device.setter
	def device(self, new_state):
		self._setter_access_tracker["device"] = {}
		global default_state
		self._device = TextBox(new_state, default_state["device"])

	@property
	def Efficient(self):
		self._getter_access_tracker["Efficient"] = {}
		return self._Efficient
	@Efficient.setter
	def Efficient(self, new_state):
		self._setter_access_tracker["Efficient"] = {}
		global default_state
		self._Efficient = TextBox(new_state, default_state["Efficient"])

	@property
	def clean(self):
		self._getter_access_tracker["clean"] = {}
		return self._clean
	@clean.setter
	def clean(self, new_state):
		self._setter_access_tracker["clean"] = {}
		global default_state
		self._clean = TextBox(new_state, default_state["clean"])

	@property
	def serviceimg3(self):
		self._getter_access_tracker["serviceimg3"] = {}
		return self._serviceimg3
	@serviceimg3.setter
	def serviceimg3(self, new_state):
		self._setter_access_tracker["serviceimg3"] = {}
		global default_state
		self._serviceimg3 = Image(new_state, default_state["serviceimg3"])
	...
	@property
	def Ibringresults(self):
		self._getter_access_tracker["Ibringresults"] = {}
		return self._Ibringresults
	@Ibringresults.setter
	def Ibringresults(self, new_state):
		self._setter_access_tracker["Ibringresults"] = {}
		global default_state
		self._Ibringresults = TextBox(new_state, default_state["Ibringresults"])

	@property
	def Myclientsareproof(self):
		self._getter_access_tracker["Myclientsareproof"] = {}
		return self._Myclientsareproof
	@Myclientsareproof.setter
	def Myclientsareproof(self, new_state):
		self._setter_access_tracker["Myclientsareproof"] = {}
		global default_state
		self._Myclientsareproof = TextBox(new_state, default_state["Myclientsareproof"])

	@property
	def View(self):
		self._getter_access_tracker["View"] = {}
		return self._View
	@View.setter
	def View(self, new_state):
		self._setter_access_tracker["View"] = {}
		global default_state
		self._View = Button(new_state, default_state["View"])
	...
	@BRANDING.setter
	def BRANDING(self, new_state):
		self._setter_access_tracker["BRANDING"] = {}
		global default_state
		self._BRANDING = TextBox(new_state, default_state["BRANDING"])

	@property
	def SoulfulRebrand(self):
		self._getter_access_tracker["SoulfulRebrand"] = {}
		return self._SoulfulRebrand
	@SoulfulRebrand.setter
	def SoulfulRebrand(self, new_state):
		self._setter_access_tracker["SoulfulRebrand"] = {}
		global default_state
		self._SoulfulRebrand = TextBox(new_state, default_state["SoulfulRebrand"])
	...
	@property
	def Latest(self):
		self._getter_access_tracker["Latest"] = {}
		return self._Latest
	@Latest.setter
	def Latest(self, new_state):
		self._setter_access_tracker["Latest"] = {}
		global default_state
		self._Latest = TextBox(new_state, default_state["Latest"])

	@property
	def viewall(self):
		self._getter_access_tracker["viewall"] = {}
		return self._viewall
	@viewall.setter
	def viewall(self, new_state):
		self._setter_access_tracker["viewall"] = {}
		global default_state
		self._viewall = TextBox(new_state, default_state["viewall"])
	...
	def PRODUCT_DESIGNER(self):
		self._getter_access_tracker["PRODUCT_DESIGNER"] = {}
		return self._PRODUCT_DESIGNER
	@PRODUCT_DESIGNER.setter
	def PRODUCT_DESIGNER(self, new_state):
		self._setter_access_tracker["PRODUCT_DESIGNER"] = {}
		global default_state
		self._PRODUCT_DESIGNER = TextBox(new_state, default_state["PRODUCT_DESIGNER"])

	@property
	def Thatme(self):
		self._getter_access_tracker["Thatme"] = {}
		return self._Thatme
	@Thatme.setter
	def Thatme(self, new_state):
		self._setter_access_tracker["Thatme"] = {}
		global default_state
		self._Thatme = TextBox(new_state, default_state["Thatme"])
	...
	@property
	def Stanford(self):
		self._getter_access_tracker["Stanford"] = {}
		return self._Stanford
	@Stanford.setter
	def Stanford(self, new_state):
		self._setter_access_tracker["Stanford"] = {}
		global default_state
		self._Stanford = TextBox(new_state, default_state["Stanford"])
	...
	def TESTIMONIALS(self, new_state):
		...
		global default_state
		self._TESTIMONIALS = TextBox(new_state, default_state["TESTIMONIALS"])
	...
	@property
	def Ready(self):
		self._getter_access_tracker["Ready"] = {}
		return self._Ready
	@Ready.setter
	def Ready(self, new_state):
		self._setter_access_tracker["Ready"] = {}
		global default_state
		self._Ready = TextBox(new_state, default_state["Ready"])
	...
	def _to_json_fields(self):
		return {
			...
			"Flex5": self._Flex5,
			"image": self._image,
			"trustedsection": self._trustedsection,
			"Div5": self._Div5,
			"Div6": self._Div6,
			"Flex7": self._Flex7,
			"servicesection": self._servicesection,
			"Div7": self._Div7,
			"Div8": self._Div8,
			"Flex9": self._Flex9,
			"Div9": self._Div9,
			...
			"Flex25": self._Flex25,
			"Flex26": self._Flex26,
			"productsection": self._productsection,
			"Flex39": self._Flex39,
			"Div34": self._Div34,
			"Div35": self._Div35,
			"images": self._images,
			"Flex40": self._Flex40,
			"Flex41": self._Flex41,
			"worksection": self._worksection,
			"Div37": self._Div37,
			"standfordbox": self._standfordbox,
			"Flex45": self._Flex45,
			"Flex46": self._Flex46,
			"Flex47": self._Flex47,
			"Flex51": self._Flex51,
			...
			"Blog": self._Blog,
			"bookacall": self._bookacall,
			"arrow": self._arrow,
			"subtext": self._subtext,
			"text2": self._text2,
			"text1": self._text1,
			"download": self._download,
			"bookacallbutton": self._bookacallbutton,
			"Image37": self._Image37,
			"personimg": self._personimg,
			"Trusted_by": self._Trusted_by,
			"logoispum1": self._logoispum1,
			"logoispum2": self._logoispum2,
			"logoispum3": self._logoispum3,
			"logoispum4": self._logoispum4,
			"SERVICES": self._SERVICES,
			"servicesubtext": self._servicesubtext,
			"box1titlte": self._box1titlte,
			"box1subtext": self._box1subtext,
			"serviceimg1": self._serviceimg1,
			"Design": self._Design,
			"Front": self._Front,
			"Web": self._Web,
			"box2subtext": self._box2subtext,
			"box2titlte": self._box2titlte,
			"Webflow": self._Webflow,
			"Figma": self._Figma,
			"_Sketch": self.__Sketch,
			"serviceimg2": self._serviceimg2,
			"box3subtext": self._box3subtext,
			"box3titlte": self._box3titlte,
			"device": self._device,
			"Efficient": self._Efficient,
			"clean": self._clean,
			"serviceimg3": self._serviceimg3,
			"PROJECTS": self._PROJECTS,
			"Ibringresults": self._Ibringresults,
			"Myclientsareproof": self._Myclientsareproof,
			"View": self._View,
			"BRANDING": self._BRANDING,
			"SoulfulRebrand": self._SoulfulRebrand,
			...
			"PRODUCT_DESIGNER": self._PRODUCT_DESIGNER,
			"Thatme": self._Thatme,
